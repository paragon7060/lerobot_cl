...
class RoboCasaEnv(HubEnvConfig):
    ...
    obs_type: str = "pixels_agent_pos"
    render_mode: str = "rgb_array"
    camera_name: str = "robot0_agentview_left,robot0_agentview_right,robot0_eye_in_hand"
    hard_reset: bool = False
    force_named_camera_renders: bool = False
    fix_camera_permutation: bool = True
    debug_camera_permutation: bool = False
    debug_camera_permutation_max_logs: int = 20
    render_camera_name: str | None = "robot0_agentview_center"
    render_policy_cameras: bool = False
    debug_camera_health: bool = False
    debug_camera_health_max_logs: int = 5
    debug_camera_corrected_health: bool = False
    debug_camera_corrected_health_max_logs: int = 5
    debug_camera_named_compare: bool = False
    debug_camera_named_compare_steps: str = ""
